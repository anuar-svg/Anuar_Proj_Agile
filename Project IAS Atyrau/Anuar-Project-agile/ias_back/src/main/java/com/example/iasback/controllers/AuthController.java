...
import com.example.iasback.services.SignService;
...
public class AuthController {
    ...
    @GetMapping("login_ecp")
    public ResponseEntity<?> ecpLogin(String iin) {
        return signService.loginByElectronCard(iin);
