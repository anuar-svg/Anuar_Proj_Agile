<template>
  <div class="container-fluid" style="width: 60vw;" v-if="htmlRegions">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <HorizontalBar
                :chartData="[numberOfTeachers]"
                :chartLabels="[htmlYears]"
                :chartColors="regionsChartColors"
                label="КОЛ-ВО ПЕДАГОГОВ, человек"
                />
            </div>
            <div class="col-4">
                <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                <PieChart
                :chartData="[before30, from30to39, from40to49, from50to59, after59]"
                :chartLabels="['ДО 30 ЛЕТ', 'ОТ 30 ДО 39 ЛЕТ', 'ОТ 40 ДО 49 ЛЕТ', 'ОТ 50 ДО 59 ЛЕТ', 'ПОСЛЕ 59 лет']"
                :chartColors="regionsChartColors"
        ...
        <div class="row">
            <div class="col-12 d-flex">
                <div class="col-6">
                    <BarChart
                    :height="200"
                    :chartData="[withHighEducation, withCollegeEducation]"
                    :chartLabels="['ИМЕЕТ ВЫСШЕЕ ОБРАЗОВАНИЕ', 'ССУЗ']"
                    :chartColors="regionsChartColors"
                    label="ПЕДАГОГИ ПО ОБРАЗОВАНИЮ, человек"
                    />
                </div>
                <div class="col-6">
                    <BarChart
                    ...
                    :chartColors="regionsChartColors"
                    label="ПЕДАГОГИ ПО СТАЖУ, человек"
                    />
                </div>
            </div>
                <p class="text-center col-12" style="font-size: .7rem">ПОТРЕБНОСТЬ КАДРОВ, человек</p>
                <div class="col-12" style="max-height: 35vh; overflow: scroll; font-size: .8rem">
                    <table class="table">
