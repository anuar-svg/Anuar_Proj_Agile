  ...
  <div class="container-fluid" style="width: 60vw;" v-if="htmlRegions">
        ...
        <div class="row">
            <div class="col-12 d-flex">
                ...
                <div class="col-6">
                    <BarChart
                    :chartData="[withHighEducation, withSecondaryEducation, withCollegeEducationInteger]"
                ...
                <p class="col-12 text-center" style="font-size: .7rem">ПОТРЕБНОСТЬ КАДРОВ, человек</p>
