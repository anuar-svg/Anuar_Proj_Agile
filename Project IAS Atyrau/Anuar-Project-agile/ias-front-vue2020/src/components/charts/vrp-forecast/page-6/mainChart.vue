  ...
  <div class="container-fluid" style="width: 60vw;" v-if="htmlRegions">
        ...
        <div class="row">
            <div class="col-12">
                <HorizontalBar
                :height="70"
                :chartData="[withHighEducation, withCollegeEducation, withHighEducation, withCollegeEducation]"
                :chartLabels="['ИМЕЕТ ВЫСШЕЕ ОБРАЗОВАНИЕ', 'ССУЗ', 'ИМЕЕТ ВЫСШЕЕ ОБРАЗОВАНИЕ', 'ССУЗ']"
                :chartColors="regionsChartColors"
