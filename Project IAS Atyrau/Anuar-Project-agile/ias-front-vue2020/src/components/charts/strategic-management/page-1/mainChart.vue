<template>
  <div class="container-fluid" style="width: 60vw;" v-if="htmlRegions">
            ...
            <div class="col-12 d-flex">
                <div class="col-4">
                    <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                        ...
                        :scale-interval="0.1"
                        />
                    <span style="position: absolute; left:140px; top:200px">1.3</span>
                </div>
                <div class="col-4">
                    <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                        <VueSvgGauge
                        ...
                        :scale-interval="0.1"
                        />
                    <span style="position: absolute; left:140px; top:200px">1.7</span>
                </div>
                <div class="col-4">
                    <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                        <VueSvgGauge
                        ...
                        :scale-interval="0.1"
                        />
                    <span style="position: absolute; left:140px; top:200px">3</span>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 d-flex">
                <div class="col-4">
                    <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                        ...
                        :min="0"
                        :max="3"
                        :gauge-color="[{ offset: 0, color: 'green'}, { offset: 50, color: 'yellow'}, { offset: 100, color: 'red'}]"
                        :scale-interval="0.1"
                        />
                    <span style="position: absolute; left:150px; top:200px">3</span>
                </div>
                <div class="col-4">
                    <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                        <VueSvgGauge
                        ...
                        :scale-interval="0.1"
                        />
                    <span style="position: absolute; left:150px; top:200px">2.6</span>
                </div>
                <div class="col-4">
                    <p style="text-align: center; font-size: .7rem">ПЕДАГОГИ ПО ВОЗРАСТУ, человек</p>
                        <VueSvgGauge
                        ...
                        :scale-interval="0.1"
                        />
                    <span style="position: absolute; left:150px; top:200px">2.7</span>
                </div>
            </div>
        </div>
        <ul class="pagination pagination-sm d-flex justify-center">
            ...
            <v-card class="page-link disabled" to="1">3</v-card>
            <v-card class="page-link disabled" to="1">4</v-card>
            <v-card class="page-link disabled" to="1">5</v-card>
            <v-card class="page-link disabled" to="1">6</v-card>
            <v-card class="page-link disabled" to="1">7</v-card>
        </ul>
  </div>
</template>
