<template>
  <div class="container-fluid" style="width: 60vw;" v-if="htmlRegions">
        ...
        <div class="row">
            ...
            <div class="col-6" style="max-height: 35vh; overflow: scroll; font-size: .8rem">
                <table class="table">
        ...
        <ul class="pagination pagination-sm d-flex justify-center">
            ...
            <v-card class="page-link disabled" to="2">3</v-card>
            <v-card class="page-link disabled" to="2">4</v-card>
            <v-card class="page-link disabled" to="2">5</v-card>
            <v-card class="page-link disabled" to="2">6</v-card>
            <v-card class="page-link disabled" to="2">7</v-card>
        </ul>
  </div>
</template>
