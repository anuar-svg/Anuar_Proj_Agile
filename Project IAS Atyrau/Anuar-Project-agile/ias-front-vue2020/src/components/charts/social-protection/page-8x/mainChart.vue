    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <HorizontalBar
                :height="300"
                :chartData="Object.values(numberOfStudents)"
                :chartLabels="Object.keys(numberOfStudents)"
                :chartColors="regionsChartColors"
                label="КОЛ-ВО УЧЕНИКОВ, человек"
                />
            </div>
            <div class="col-6">
                <HorizontalBar
                :height="300"
                :chartData="Object.values(numberOfTeachers)"
                :chartLabels="Object.keys(numberOfTeachers)"
                :chartColors="regionsChartColors"
