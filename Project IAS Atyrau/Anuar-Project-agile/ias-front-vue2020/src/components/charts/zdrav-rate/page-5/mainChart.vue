<template>
  <div class="container-fluid" style="width: 60vw;" v-if="htmlRegions">
        <h5 class="text-center">Потребность профессий по видам экономической деятельности</h5>
        ...
        <div class="col-12 d-flex">
            <div class="col-7">
                <div class="d-flex">
                    ...
                    <div class="col-5">
                        <p style="text-align: center; font-size: .7rem">ВИДЫ ЭКОНОМИЧЕСКОЙ ДЕЯТЕЛЬНОСТИ, человек</p>
                    <PieChart
            ...
            <div class="col-5">
                <div class="col-12">
                    ...
                    <div style="max-height: 46vh; overflow: scroll; font-size: .8rem">
                        <table class="table">
